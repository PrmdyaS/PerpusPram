...
class LaporanDenda {
  Future<Uint8List> generateLaporanDenda(
        ...
        for (int i = 0; i < borrowBookList.length; i++) {
          rows.add(pw.TableRow(children: <pw.Widget>[
            ...
            pw.Padding(
              padding: const pw.EdgeInsets.all(10.0),
              child: pw.Text(
                '${borrowBookList[i].dendas!.paymentMethod}',
            ...
            pw.Padding(
              padding: const pw.EdgeInsets.all(10.0),
              child: pw.Text(
                formatDate('${borrowBookList[i].dendas!.paymentDate}'),
                textAlign: pw.TextAlign.center,
                style: const pw.TextStyle(fontSize: 10.0),
              ),
            ),
            pw.Padding(
              padding: const pw.EdgeInsets.all(10.0),
              child: pw.Text(
                '${borrowBookList[i].dendas!.officer!.username}',
                textAlign: pw.TextAlign.center,
                style: const pw.TextStyle(fontSize: 10.0),
              ),
            ),
