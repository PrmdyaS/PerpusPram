...
class LaporanDendaController extends GetxController {
  ...
  getData() async {
    ...
    try {
      final response =
          await ApiProvider.instance().get(Endpoint.laporanDenda);
  ...
  void filterData() {
    switch (selectedItem.value) {
      ...
      case 'Hari Ini':
        ...
        borrowBookList = borrowBookAllList
            .where((book) => isToday('${book.dendas!.paymentDate}'))
            .toList();
        break;
      case 'Kemarin':
        ...
        borrowBookList = borrowBookAllList
            .where((book) => isYesterday('${book.dendas!.paymentDate}'))
            .toList();
        break;
      case 'Minggu Ini':
        ...
        borrowBookList = borrowBookAllList
            .where((book) => isThisWeek('${book.dendas!.paymentDate}'))
            .toList();
        break;
      case 'Minggu Lalu':
        DateTime hariIni = DateTime.now();
        ...
        subtitleLaporan.value = 'Periode ${formatDate(tanggal1)} sampai ${formatDate(tanggal2)}';
        borrowBookList = borrowBookAllList
            .where((book) => isLastWeek('${book.dendas!.paymentDate}'))
            .toList();
        break;
      case 'Bulan Ini':
        ...
        borrowBookList = borrowBookAllList
            .where((book) => isThisMonth('${book.dendas!.paymentDate}'))
            .toList();
        break;
      case 'Bulan Lalu':
        DateTime tanggalHariIni = DateTime.now();
        ...
        borrowBookList = borrowBookAllList
            .where((book) => isLastMonth('${book.dendas!.paymentDate}'))
            .toList();
        break;
      case 'Tahun Ini':
        ...
        borrowBookList = borrowBookAllList
            .where((book) => isThisYear('${book.dendas!.paymentDate}'))
            .toList();
        break;
      case 'Tahun Lalu':
        ...
        borrowBookList = borrowBookAllList
            .where((book) => isLastYear('${book.dendas!.paymentDate}'))
            .toList();
        break;
      default:
        break;
